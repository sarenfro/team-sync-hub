...
const TeamMemberSelect = ({ members, onSelect, onSelectAll }: TeamMemberSelectProps) => {
  ...
  hover:shadow-lg hover:shadow-booking-hero/5 border-border bg-card hover:border-booking-hero"
          >
            <div
  ...
  text-primary-foreground ${avatarColors[member.colorIndex % avatarColors.length]}`}
            ...
            <div className="text-center space-y-1">
              <h3 className="font-semibold transition-colors text-foreground group-hover:text-booking-hero">
                {member.name}
              </h3>
